...
//    [IQKeyboardManager sharedManager].enableAutoToolbar = NO;
    ...
    [[UINavigationBar appearance] setBarTintColor:THEMEColor];//设置导航颜色
    [[UINavigationBar appearance] setTintColor:WhiteColor];//设置导航文字颜色
    self.window.rootViewController = [[MMainViewController alloc] init];
