...
//DES加密
+(NSString *)DESEncryptSting:(NSString *)sText key:(NSString *)key andDesiv:(NSString *)ivDes
{
...
//DES解密
+(NSString *)DESDecryptWithDESString:(NSString *)sText key:(NSString *)key andiV:(NSString *)iv
{
    if ((sText == nil || sText.length == 0)
        || (sText == nil || sText.length == 0)
        || (iv == nil || iv.length == 0)) {
